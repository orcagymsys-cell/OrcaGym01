      ...
      <aside className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-gray-200 flex flex-col items-center py-4 md:py-6 md:h-screen md:sticky md:top-0 shrink-0">
        ...
        <nav className="w-full flex md:flex-col overflow-x-auto md:overflow-x-visible space-x-2 md:space-x-0 md:space-y-2 px-3 md:px-4 py-3 md:py-0 mt-3 md:mt-6 flex-1 text-xs md:text-sm font-bold no-scrollbar">
          <button 
            ...
            className={`whitespace-nowrap md:w-full flex items-center space-x-1.5 md:space-x-2 shrink-0 px-2.5 md:px-4 py-1.5 md:py-2.5 rounded-lg md:rounded-xl transition-all ${activeTab === 'dashboard' ? 'bg-[#183363] text-white shadow-md' : 'text-[#183363] hover:bg-blue-50'}`}
          >
            <Home size={16} />
            <span>HOME</span>
          </button>
          ...
          <button 
            ...
            className={`whitespace-nowrap md:w-full flex items-center space-x-1.5 md:space-x-2 shrink-0 px-2.5 md:px-4 py-1.5 md:py-2.5 rounded-lg md:rounded-xl transition-all ${activeTab === 'members' ? 'bg-[#183363] text-white shadow-md' : 'text-[#183363] hover:bg-blue-50'}`}
          >
            <Users size={16} />
            <span>MEMBERS</span>
          </button>
          ...
          <button 
            ...
            className={`whitespace-nowrap md:w-full flex items-center space-x-1.5 md:space-x-2 shrink-0 px-2.5 md:px-4 py-1.5 md:py-2.5 rounded-lg md:rounded-xl transition-all ${activeTab === 'classes' ? 'bg-[#183363] text-white shadow-md' : 'text-[#183363] hover:bg-blue-50'}`}
          >
            <Package size={16} />
            <span>CLASSES</span>
          </button>
          ...
          <button 
            ...
            className={`whitespace-nowrap md:w-full flex items-center space-x-1.5 md:space-x-2 shrink-0 px-2.5 md:px-4 py-1.5 md:py-2.5 rounded-lg md:rounded-xl transition-all ${activeTab === 'schedule' ? 'bg-[#183363] text-white shadow-md' : 'text-[#183363] hover:bg-blue-50'}`}
          >
            <Calendar size={16} />
            <span>SCHEDULE</span>
          </button>
          ...
          <button 
            ...
            className={`whitespace-nowrap md:w-full flex items-center space-x-1.5 md:space-x-2 shrink-0 px-2.5 md:px-4 py-1.5 md:py-2.5 rounded-lg md:rounded-xl transition-all ${activeTab === 'audit' ? 'bg-emerald-700 text-white shadow-md' : 'text-emerald-800 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200'}`}
          >
            <ShieldCheck size={16} />
            <span>AUDIT</span>
          </button>
          ...
          <button 
            ...
            className={`whitespace-nowrap md:w-full flex items-center space-x-1.5 md:space-x-2 shrink-0 px-2.5 md:px-4 py-1.5 md:py-2.5 rounded-lg md:rounded-xl transition-all ${activeTab === 'about' ? 'bg-[#183363] text-white shadow-md' : 'text-[#183363] hover:bg-blue-50'}`}
          >
            <Info size={16} />
            <span>ABOUT US</span>
          </button>
